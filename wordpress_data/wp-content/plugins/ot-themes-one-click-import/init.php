<?php
	/**
 	* Plugin Name: OT one click import content
...
class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
     ...
     * @var object
     */
    public $theme_option_name = 'eleos_option'; //set theme options name here - Davis change
	...
	public function set_demo_menus() {
		...
		$main_menu = get_term_by('name', 'Primary Menu', 'nav_menu'); // - Davis change				
	...
	public function set_demo_home(){
		$page = get_page_by_title( 'Homepage' ); // Edit home page name you want to set here. - Davis change
		if ( isset( $page->ID ) ) {
